-- Migration: Add farm pin coordinates to submit_complete_farmer_registration RPC
-- Purpose:
--   - Allow registration flow to store farm_latitude and farm_longitude
--   - Preserve existing behavior for clients that submit without coordinates
