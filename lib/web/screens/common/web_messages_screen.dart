...
import 'web_conversation_screen.dart';
...
class _WebMessagesScreenState extends State<WebMessagesScreen> {
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            'Start a conversation with a farmer or customer',
            style: GoogleFonts.plusJakartaSans(
              fontSize: 14,
  ...
  Widget _buildConversationTile(Conversation conversation) {
    final otherName = _currentUserId != null
        ...
        : 'Unknown';
    final otherAvatar = _currentUserId != null
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(context).push(
            MaterialPageRoute(
              builder: (context) => WebConversationScreen(
