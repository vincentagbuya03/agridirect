...
class _WebPreorderDetailsState extends State<WebPreorderDetails> {
  ...
  Future<void> _submitOrder() async {
    ...
    try {
      await _orderService.createOfflinePreOrderByProductId(
        productId: productId,
        quantity: _quantity.toDouble(),
        paymentMethod: _selectedPaymentMethod,
        notes: 'Web marketplace order',
      );
      if (!mounted) return;
  ...
  Widget _buildImageGallery() {
    final images = _product!.imageUrls.isNotEmpty
        ...
        : (_product!.imageUrl.isNotEmpty
              ...
              : <String>[]);
    final primaryImage = images.isNotEmpty ? images.first : '';
                ...
                itemBuilder: (_, index) {
                  return ClipRRect(
                    ...
                    child: CachedNetworkImage(
                      ...
                      fit: BoxFit.cover,
                      placeholder: (ctx, url) =>
                          Container(width: 84, color: Colors.grey[100]),
        ...
        children: [
          CircleAvatar(
            ...
            child: avatarUrl.isEmpty
                ? const Icon(Icons.storefront_rounded, color: _primary)
                : null,
          ),
