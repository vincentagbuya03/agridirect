...
class _CreatePostDialogState extends State<CreatePostDialog> {
  ...
  Future<void> _pickImage() async {
    try {
      ...
      _showCustomSnackBar(
        FarmerLocaleService.instance.s('Error picking image: $e', 'May error sa pagpili ng larawan: $e'),
        isError: true,
      );
    }
  }
  ...
  Future<void> _pickVideo() async {
    try {
      ...
      _showCustomSnackBar(
        FarmerLocaleService.instance.s('Error picking video: $e', 'May error sa pagpili ng video: $e'),
        isError: true,
      );
    }
  }
  ...
  Future<void> _submit() async {
    ...
    if (body.isEmpty) {
      _showCustomSnackBar(
        locale.s('Please write something first!', 'Mangyaring magsulat muna!'),
        isError: true,
      );
      return;
    }
    ...
    try {
      ...
      if (mounted) {
        _showCustomSnackBar(
          locale.s('Post published successfully!', 'Matagumpay na nai-post!'),
          isError: false,
        );
      ...
      if (mounted) {
        _showCustomSnackBar(
          locale.s('Failed to post: $e', 'Nabigong mag-post: $e'),
          isError: true,
        );
      }
    } finally {
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            locale.s('Create post', 'Gumawa ng Post'),
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          locale.s('Public Community Hub', 'Pampublikong Hub ng Komunidad'),
                        ...
                        TextField(
                          ...
                          decoration: InputDecoration(
                            hintText: locale.s(
                              ...
                              "Ano ang nasa isip mo, $firstName?",
                            ),
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                locale.s(
                                                  ...
                                                  'Napiling video (Handa nang i-upload)',
                                                ),
                                                style: GoogleFonts.inter(
                                                  fontSize: 12,
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              Expanded(
                                child: Text(
                                  locale.s('Add to your post', 'Idagdag sa iyong post'),
                                  style: GoogleFonts.plusJakartaSans(
                                    fontSize: 14,
                                    fontWeight: FontWeight.w700,
                              ...
                              IconButton(
                                ...
                                tooltip: locale.s('Photo', 'Larawan'),
                                style: IconButton.styleFrom(
